export default {
    ...
    exampleTimeFormatNote: 'Формат времени задается в объекте локализации или в опции {paramName}. Для отображения времени в 12-часовом варианте, используйте символы {hSym} или {hhSym}. Чтобы отобразить период дня добавьте {dateFormataa} или {dateFormatAA}.',
    ...
    exampleAvailableDatesUsage: 'Отключение дат',
    exampleAvailableDatesUsage2: 'Для разрешения выбора только некоторых дат, нужно передать параметры, как в примере ниже.',
    ...
    optsDateFormatdd: 'день месяца с ведущим нулем',
    optsDateFormatM: 'номер месяца',
    optsDateFormatMM: 'номер месяца с ведущим нулем',
    ...
    optsTimeFormathh: 'часы в 12-часовом формате с ведущим нулем',
    optsTimeFormatH: 'часы в 24-часовом формате',
    optsTimeFormatHH: 'часы в 24-часовом формате с ведущим нулем',
    optsTimeFormatm: 'минуты',
    optsTimeFormatmm: 'минуты с ведущим нулем',
    ...
    optsAvailableDates: 'Используется для включения только некоторых дат. Остальные даты будут отключены для выбора.',
    optsAvailableDates2: 'Применение:',
    ...
    eventsOnSelectChangeEvent: 'При выборе даты или изменении времени в календаре элемент {inputField} генерирует событие {changeField}.',
